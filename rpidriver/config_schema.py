...
CONFIG_SCHEMA = {
    ...
    "neoleap_driver": {
        ...
        "timeout": {
            ...
            "min"    : 5,
            "max"    : 600,
            "help"   : "Seconds to wait for the customer to complete a payment (5 – 600).",
        },
        "state_ttl": {
            "type"   : "number",
            ...
            "min"    : 5,
            "max"    : 300,
            "help"   : "Seconds before a completed transaction auto-resets to idle (5 – 300).",
        },
    },
    ...
    "escpos_driver": {
        ...
        "usb_vendor": {
            ...
            "placeholder": "04b8",
            "maxlength"  : 8,
            "help"       : "Hex vendor ID to pin a specific printer (e.g. 04b8 for Epson). Leave empty to auto-detect.",
        },
        "usb_product": {
            "type"       : "text",
            ...
            "placeholder": "0e15",
            "maxlength"  : 8,
            "help"       : "Hex product ID (e.g. 0e15 = TM-T20, 0e28 = TM-T82, 0202 = TM-T88). Leave empty to auto-detect.",
        },
    },
    ...
    "scale_driver": {
        ...
        "timeout": {
            ...
            "max"    : 10.0,
            "step"   : "0.1",
            "help"   : "Serial read timeout per polling cycle (0.1 – 10.0 s).",
        },
    },
    ...
    "display_driver": {
        ...
        "baudrate": {
            ...
            "min"    : 300,
            "max"    : 115200,
            "help"   : "Serial baud rate (300 – 115200).  Most 2×20 displays use 9600.",
        },
    },
